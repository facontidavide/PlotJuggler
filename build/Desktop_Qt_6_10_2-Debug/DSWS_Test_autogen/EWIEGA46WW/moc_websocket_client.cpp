...
QT_MOC_LITERAL(3, 24, 11), // "onConnected"
QT_MOC_LITERAL(4, 36, 21), // "onTextMessageReceived"
QT_MOC_LITERAL(5, 58, 7), // "message"
QT_MOC_LITERAL(6, 66, 23), // "onBinaryMessageReceived"
QT_MOC_LITERAL(7, 90, 14), // "onDisconnected"
QT_MOC_LITERAL(8, 105, 7), // "onError"
QT_MOC_LITERAL(9, 113, 28) // "QAbstractSocket::SocketError"

    },
    "WebsocketClient\0closed\0\0onConnected\0"
    "onTextMessageReceived\0message\0"
    "onBinaryMessageReceived\0onDisconnected\0"
...
void WebsocketClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onBinaryMessageReceived((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
