...
#include <memory>
#include "../../../../../../PlotJuggler/plotjuggler_base/src/plotmagnifier.h"
...
QT_MOC_LITERAL(1, 14, 8), // "rescaled"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8) // "new_size"

    },
    "PlotMagnifier\0rescaled\0\0new_size"
};
...
void PlotMagnifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PlotMagnifier::*)(QRectF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlotMagnifier::rescaled)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlotMagnifier::rescaled(QRectF _t1)
{
