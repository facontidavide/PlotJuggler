...
#include <memory>
#include "../../../../../../../../../PlotJuggler/3rdparty/qwt/src/qwt_scale_widget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QwtScaleWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QwtScaleWidget_t qt_meta_stringdata_QwtScaleWidget = {
    {
QT_MOC_LITERAL(0, 0, 14), // "QwtScaleWidget"
QT_MOC_LITERAL(1, 15, 15), // "scaleDivChanged"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "QwtScaleWidget\0scaleDivChanged\0"
};
...
void QwtScaleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QwtScaleWidget::scaleDivChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QwtScaleWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_QwtScaleWidget.data,
