...
#include <memory>
#include "../../../../../../../../../PlotJuggler/3rdparty/qwt/src/qwt_dyngrid_layout.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QwtDynGridLayout_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QwtDynGridLayout_t qt_meta_stringdata_QwtDynGridLayout = {
    {
QT_MOC_LITERAL(0, 0, 16) // "QwtDynGridLayout"
...
QT_INIT_METAOBJECT const QMetaObject QwtDynGridLayout::staticMetaObject = { {
    QMetaObject::SuperData::link<QLayout::staticMetaObject>(),
    qt_meta_stringdata_QwtDynGridLayout.data,
    qt_meta_data_QwtDynGridLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QwtDynGridLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QwtDynGridLayout.stringdata0))
