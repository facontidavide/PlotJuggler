...
template QString DataViewPanel::formatMetadata(
    const std::map<std::string, std::string>&, const QString&);
template QString DataViewPanel::formatMetadata(
    const std::unordered_map<std::string, std::string>&, const QString&);
