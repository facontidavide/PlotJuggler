...
{
  guardedBoundary(
      "onMosaicoTopicStarted",
      [&]() { beginTopicImport(sequence_name, topic_name, schema); },
      [this]() { emit closed(); });
}

void ToolboxMosaico::onMosaicoTopicBatchReady(
    const QString& sequence_name, const QString& topic_name,
...
void ToolboxMosaico::onMosaicoTopicFinished(const QString& sequence_name,
