...
class MosaicoClient {
 public:
    ...
    arrow::Result<TopicInfo> getTopicMetadata(
        const std::string& sequence_name,
    ...
    using TopicCompleteCallback = std::function<void(
    ...
    arrow::Status deleteTopic(const std::string& sequence_name,
                              const std::string& topic_name);
    ...
    arrow::Status reportTopicNotification(const std::string& sequence_name,
                                          ...
                                          const std::string& type,
                                          const std::string& message);
    arrow::Result<std::vector<Notification>> listSequenceNotifications(
        const std::string& sequence_name);
    arrow::Result<std::vector<Notification>> listTopicNotifications(
